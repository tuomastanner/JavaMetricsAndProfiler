...
public class AnalyzerStructure extends Analyzer {
    ...
    public AnalyzerStructure(Logger logger) {
        super(logger); metrics.Profiler.write("entry;metrics.AnalyzerStructure;public AnalyzerStructure(Logger logger)"); 
     metrics.Profiler.write("exit;metrics.AnalyzerStructure;public AnalyzerStructure(Logger logger)"); }

    public String analyzeFile(File file, Object additionalParam) { metrics.Profiler.write("entry;metrics.AnalyzerStructure;public String analyzeFile(File file, Object additionalParam)"); 
        ...
        while(true) {
            ...
            if (result[0] == -1) {
                logger.log("END REACHED", 3);
                 metrics.Profiler.write("exit;metrics.AnalyzerStructure;public String analyzeFile(File file, Object additionalParam)"); return "\nFile belongs to package: " + packageName + "\n\nImports " + 
