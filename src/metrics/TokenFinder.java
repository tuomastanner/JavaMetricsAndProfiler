...
public class TokenFinder {
	 ...
	 * @param tokens
	 */
	public TokenFinder(String text, String[] tokens) {
	 ...
	 */
	public int[] getNextToken(int startFrom) {
		int curToken = 0;
		int tokenPos = 0;
	 ...
	 */
	public int findToken(String token, int startFrom) {
	 ...
	 * @return
	 */
	public int findToken(String token, String text, int startFrom) {
		textArr = text.toCharArray();
		return findToken(token, startFrom);
	}
	
	public int findPrevious(char c, int startFrom) {
