...
public class GetMetrics {
	...
	public static void main(String[] args) {
		...
		if (args.length < 2) {
			System.out.println("Usage: java GetMetrics [lines, structure, object-metrics, profiler] <name of file to be counted> [debug]");
			return;
		}
	 ...
	 */
	public static String processFiles(File startDir, Analyzer analyzer, Object additionalParam) {
		String results = "";
